...
import {GameEntityObject} from '../../rpg/objects/all';
import {GameWorld} from '../../gameWorld';
import {CombatMap} from './combatMap';
import {IPlayerAction} from '../../rpg/states/playerCombatState';
import {IChooseActionEvent} from '../../rpg/states/combat/combatChooseActionState';
import {CombatMagicComponent, CombatActionComponent, CombatItemComponent} from '../../rpg/components/combat/actions/all';
import {UsableModel} from '../../rpg/models/all';
...
export class ChooseActionStateMachine extends StateMachine {
  ...
  scene: Scene;
  player: PlayerCombatRenderComponent = null;
...
export class ChooseActionType extends State {
  ...
  enter(machine: ChooseActionStateMachine) {
    ...
    machine.player = <PlayerCombatRenderComponent>
      p.findComponent(PlayerCombatRenderComponent);
    if (!machine.player) {
