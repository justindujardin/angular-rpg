import { IPartyMember } from '../base-entity';
import { CombatVictoryAction, CombatVictorySummary } from '../combat/combat.actions';
import { addEntityToCollection, EntityCollectionRecord } from '../entity-collections';
import {
  ...
  describe('Actions', () => {
    ...
    describe('CombatVictoryAction', () => {
      ...
      it('should update state of party members coming out of combat', () => {
        ...
        const initial: EntityStateRecord = defaultState('beings', [
          victoryMemberBefore,
          victorySecondBefore,
        ]);
        const actual = entityReducer(
        ...
        expect(entity.strength[0]).toBe(victoryMemberAfter.strength[0]);
        ...
        expect(second.strength[0]).toBe(victorySecondAfter.strength[0]);
