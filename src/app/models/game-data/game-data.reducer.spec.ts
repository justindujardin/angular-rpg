...
describe('GameData', () => {
  function defaultState(
    ...
    if (collection && items) {
      resultState = resultState.updateIn(
        [collection],
  ...
  describe('Actions', () => {
    describe('GameDataAddSheetAction', () => {
      it('should add a sheet of data to a table with the given name', () => {
        ...
        const out = gameDataReducer(
          initial,
          new GameDataAddSheetAction('weapons', [item])
        ) as GameDataStateRecord;
    ...
    describe('GameDataRemoveSheetAction', () => {
      it('should remove all data from a sheet with the given name', () => {
        ...
        const out = gameDataReducer(
          initial,
          new GameDataRemoveSheetAction('weapons')
        ) as GameDataStateRecord;
